...
export const productsAPI = {
  getAll: async () => {
    return await apiRequest('/products/list');
  },

  getLowStock: async () => {
    return await apiRequest('/products/low-stock');
  },

  create: async (product: { name: string; stock: number; price: number; emoji?: string }) => {
  ...
  updateStock: async (id: string, action: 'add' | 'remove', quantity: number) => {
  ...
  update: async (id: string, product: { name?: string; stock?: number; price?: number; emoji?: string }) => {
...
export const salesAPI = {
  ...
  getSummary: async () => {
    return await apiRequest('/sales/summary');
  },

  create: async (productId: string, quantity: number) => {
    return await apiRequest('/sales/add', {
      method: 'POST',
